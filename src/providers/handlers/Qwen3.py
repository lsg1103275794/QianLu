"""
Qwen3 API handler (OpenAI-compatible).
"""
import json
import aiohttp
...
class Qwen3Handler(BaseAPIHandler):
    """Template class for handling OpenAI-compatible API interactions.
    
    Note: This is an auto-generated handler for Qwen3.
    ...
    **This template now expects flattened configuration based on environment variables.**
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.provider_name = config.get('provider_name', 'Qwen3') 
